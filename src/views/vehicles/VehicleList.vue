        ...
        >
          ...
          <template #[`cell(status)`] ="{ item }">
            <span :class="[
              ...
              item.status === 'Booked' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300' : 
          ...
          <template #[`cell(is_rented)`]="{ item }">
            <span v-if="item.is_rented" class="text-yellow-600 dark:text-yellow-400 flex items-center">
              <span class="material-icons text-sm mr-1">check</span> Yes
            </span>
            <span v-else class="text-gray-600 dark:text-gray-400 flex items-center">
              <span class="material-icons text-sm mr-1">close</span> No
            </span>
          </template>
          ...
          <template #actions="{ item }">
            <div class="flex items-center space-x-3">
              ...
              <button 
                v-if="isAdmin && item.status !== 'Booked'"
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div class="mt-2">
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Are you sure you want to delete the vehicle "{{ vehicleToDelete?.registration_no }}"? This action cannot be undone.
                    </p>
                  </div>
                </div>
              </div>
